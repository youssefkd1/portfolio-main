...
const projects = [
  ...
  },
  {
    ...
    description: 'Premium coffee e-commerce platform featuring smooth animations and modern design excellence.',
  ...
  },
  {
    ...
    description: 'Elegant online bookstore platform with premium interface and fluid user experience.',
    tech: ['html', 'css', 'javascript'],
  ...
  {
    title: 'Food Website',
    description: 'Modern culinary platform delivering exceptional design and seamless browsing experience.',
    tech: ['html', 'css', 'javascript'],
  ...
  {
    title: 'AI Chat App',
    description: 'Intelligent conversational AI application powered by advanced language models.',
    tech: ['react', 'puter', 'tailwind'],
  ...
  },
  {
    ...
    description: 'Professional image processing tool delivering fast and reliable background removal.',
    tech: ['react', 'puter', 'tailwind'],
